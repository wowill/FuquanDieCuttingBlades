                    ...
                    if ($('#vc_ui-panel-edit-element[data-vc-shortcode="et_language_switcher"]').length) {
                        ...
                        ---------------*/
                            ...
                            var align                        = edit_element.find('select[name="align"] option:selected').val(),
                                ...
                                size_value                     = edit_element.find('input[name="size_value"]').val();
                            ...
                            if (icon_size_type == "custom" && icon_size.length) {
                                CSS += '#language-switcher-'+ID+' .language-toggle.active {';
                                    CSS += 'font-size:'+(icon_size*0.8)+'px;';
                                CSS += '}';
                            }

                            CSS += '#language-switcher-'+ID+' .language-toggle:hover {';
                            ...
                            if (submenu_width.length) {
                                CSS += '#language-switcher-'+ID+' .box-align-center ul {';
                                    CSS += 'margin-left:-'+(submenu_width/2)+'px;';
                                CSS += '}';
                            }

                            CSS += '#language-switcher-'+ID+' ul li a {';
                            ...
                            CSS += '#language-switcher-'+ID+' ul li a:hover {';
