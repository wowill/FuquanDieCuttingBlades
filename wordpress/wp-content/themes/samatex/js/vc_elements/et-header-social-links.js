    ...
    $( document ).ajaxComplete(function( event, xhr, settings ) {
        ...
        /*-------------*/
            ...
            var elementExists = Object.keys(dataObj).some(function(key) {
                return dataObj[key] === "et_header_social_links";
            });

        /* Edit element
        /*-------------*/

            if(dataObj['action'] == "vc_edit_form" && dataObj['tag'] == "et_header_social_links"){

                var edit_element = $('#vc_ui-panel-edit-element[data-vc-shortcode="et_header_social_links"]');
                ...
                $('#vc_ui-panel-edit-element[data-vc-shortcode="et_header_social_links"] .vc_ui-button-action[data-vc-ui-element="button-save"]').on('click',function(){

                    if ($('#vc_ui-panel-edit-element[data-vc-shortcode="et_header_social_links"]').length) {

                        var CSS = '';
                        var ID  = uniqueID();

                        edit_element = $('#vc_ui-panel-edit-element[data-vc-shortcode="et_header_social_links"]');
                        ...
                        ---------------*/
                            ...
                            if (styling_original != "true") {
                                ...
                                CSS += '#header-social-links-'+ID+' a {';
                                    ...
                                    if (icon_box_size.length) {CSS += 'width:'+Math.round(icon_box_size*0.85)+'px;height:'+icon_box_size+'px;line-height:'+icon_box_size+'px;';}
                                    ...
                                    if ((icon_border_width.length && icon_border_color.length) || icon_background_color.length) {
                                        CSS += 'margin-right:4px !important;';
                                    } else {
                                        CSS += 'margin-right:0;';
                                    }
                                ...
                                CSS += '#header-social-links-'+ID+' a:hover {';
                                ...
                                if (icon_box_size.length || icon_size.length) {
                        ...
                        ---------------*/
                            ...
                            CSS += '#header-social-links-'+ID+', #header-social-links-'+ID+' a {';
            ...
            if((dataObj['action'] == "vc_load_shortcode" && elementExists)){
                ...
                if (typeof(iframe) != 'undefined' && iframe != null){
                    iframe.ready(function() {
                        ...
                        var element = doc.find('.vc_element[data-model-id="'+dataObj['shortcodes[0][id]']+'"] .header-social-links');
