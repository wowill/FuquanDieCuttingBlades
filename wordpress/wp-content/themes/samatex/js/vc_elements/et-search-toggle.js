        ...
        /*-------------*/
            ...
            if(dataObj['action'] == "vc_edit_form" && dataObj['tag'] == "et_search_toggle"){
                ...
                var element_css  = edit_element.find('textarea[name="element_css"]'),
                    ...
                    icon_val     = icon.val(),
                    icon_list    = edit_element.find('ul.admin-icon-list.icon-search'),
                ...
                if(typeof(icon_val) != "undefined" && icon_val.length){
                    ...
                    icon_list.find('li:first-child').addClass('active');
                }
                ...
                if(typeof(close_icon_val) != "undefined" && close_icon_val.length){
                    ...
                    close_icon_list.find('li:first-child').addClass('active');
                }
                    ...
                    if ($('#vc_ui-panel-edit-element[data-vc-shortcode="et_search_toggle"]').length) {
                        ...
                        ---------------*/
                            ...
                            var align                        = edit_element.find('select[name="align"] option:selected').val(),
                                icon_name                    = edit_element.find('ul.admin-icon-list.icon-search span.active').data('name'),
                            ...
                            if (icon_size_type == "custom" && icon_size.length) {
                                CSS += '#search-toggle-'+ID+'.active {';
                                    CSS += 'font-size:'+(icon_size*0.8)+'px;';
                                CSS += '}';
                            }

                            CSS += '#search-toggle-'+ID+':hover {';
                            ...
                            CSS += '#search-box-'+ID+' #searchsubmit + .search-icon {';
                                if (search_color.length) {CSS += 'color:'+search_color+' !important;';}
                            CSS += '}';
