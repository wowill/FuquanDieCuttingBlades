        ...
        /*-------------*/
            ...
            if(dataObj['action'] == "vc_edit_form" && dataObj['tag'] == "et_login_toggle"){
                ...
                var element_css  = edit_element.find('textarea[name="element_css"]'),
                    ...
                    icon_val     = icon.val(),
                    icon_list    = edit_element.find('ul.admin-icon-list.icon-user'),
                    ...
                    if ($('#vc_ui-panel-edit-element[data-vc-shortcode="et_login_toggle"]').length) {
                        ...
                        ---------------*/
                            ...
                            var align                        = edit_element.find('select[name="align"] option:selected').val(),
                                icon_name                    = edit_element.find('ul.admin-icon-list.icon-user span.active').data('name'),
                            ...
                            CSS += '#login-toggle-'+ID+' {';
                                ...
                                if (icon_box_size.length) {CSS += 'height:'+icon_box_size+'px;line-height:'+icon_box_size+'px;';}
                            ...
                            if (icon_size.length) {
                                CSS += '#login-toggle-'+ID+'.active {font-size:'+(icon_size-2)+'px;}';
                                CSS += '#login-toggle-'+ID+':before {width:'+icon_size+'px;}';
                            }

                            CSS += '#login-toggle-'+ID+':hover {';
                            ...
                            CSS += '#header-login-'+ID+' .widget_reglog {';
                            ...
                            CSS += '#header-login-'+ID+' .widget_reglog .input {';
                                ...
                                if (login_border_color.length) {
                                    CSS += 'box-shadow:inset 0 0 0 1px '+login_border_color+';';
                                } else {
                                    CSS += 'box-shadow:none;';
                                }
                            CSS += '}';
                            ...
                            CSS += '#header-login-'+ID+' .widget_reglog .button:hover {';
                                if (login_button_color_hover.length) {CSS += 'color:'+login_button_color_hover+';';}
