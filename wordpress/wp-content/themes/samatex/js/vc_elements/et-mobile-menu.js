                ...
                $('#vc_ui-panel-edit-element[data-vc-shortcode="et_mobile_menu"] .vc_ui-button-action[data-vc-ui-element="button-save"]').on('click',function(){
                    ...
                    if ($('#vc_ui-panel-edit-element[data-vc-shortcode="et_mobile_menu"]').length) {
                        ...
                        ---------------*/
                            ...
                            CSS += '#mobile-menu-'+ID+' dir-child* .menu-item dir-child* a {';
                            ...
                            CSS += '#mobile-menu-'+ID+' dir-child* .menu-item dir-child* a:hover {';
                            ...
                            if (separator_color.length ) {
                                CSS += '#mobile-menu-'+ID+' .menu-item dir-child* a:after, #mobile-menu-'+ID+' dir-child* .menu-item:last-child:after {background-color:'+separator_color+';}';
                            } else {
                                CSS += '#mobile-menu-'+ID+' .menu-item dir-child* a:after, #mobile-menu-'+ID+' dir-child* .menu-item:last-child:after {background-color:transparent;}';
                            }
                        ...
                        ---------------*/
                            ...
                            CSS += '#mobile-menu-'+ID+' dir-child* .menu-item .sub-menu .menu-item dir-child* a {';
                            ...
                            CSS += '#mobile-menu-'+ID+' dir-child* .menu-item .sub-menu .menu-item dir-child* a:hover {';
