    ...
    $( document ).ajaxComplete(function( event, xhr, settings ) {
        ...
        /*-------------*/
            ...
            var elementExists = Object.keys(dataObj).some(function(key) {
                return dataObj[key] === "et_modal_toggle";
            });
                    ...
                    if ($('#vc_ui-panel-edit-element[data-vc-shortcode="et_modal_toggle"]').length) {
                        ...
                        ---------------*/
                            ...
                            if (icon_size_type == "custom" && icon_size.length) {
                                CSS += '#modal-toggle-'+ID+'.active {';
                                    CSS += 'font-size:'+(icon_size*0.8)+'px;';
                                CSS += '}';
                            }

                            CSS += '#modal-toggle-'+ID+':hover {';
            ...
            if((dataObj['action'] == "vc_load_shortcode" && elementExists)){
                ...
                if (typeof(iframe) != 'undefined' && iframe != null){
                    iframe.ready(function() {
                        ...
                        var element = doc.find('.vc_element[data-model-id="'+dataObj['shortcodes[0][id]']+'"] .modal-container-toggle');
